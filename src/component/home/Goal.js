    ...
    return (
        ...
        <div className='  overflow-hidden bg-image3 '>
            ...
            <div className='flex flex-wrap flex-col md:flex-row  gap-5 md:justify-center  items-center mb-10 mx-auto md:mx-[1rem] pb-[8rem] pt-[5rem] '>
                <div className="flip-card w-[24rem] h-[20rem] sm:w-[21rem] sm:h-[27rem]   " data-aos="zoom-in-up">
                    <div className="flip-card-inner">
                        ...
                        <div className="flip-card-back text-left py-5 rounded-md text-2xl font-medium pt-5 px-4 shadow-lg border border-black-100 bg-white">
                            <div className='w-[18rem] mx-auto space-y-4'>
                                <img alt='vision_image' src='https://phiedge.co.in/wp-content/uploads/vision-min.jpg' className='w-[18rem] h-[16rem] object-fill' />
                ...
                <div className="flip-card w-[24rem] h-[20rem] sm:w-[21rem] sm:h-[27rem]   ">
                    <div className="flip-card-inner">
                        ...
                        <div className="flip-card-back text-left py-5 rounded-md  pt-5 px-4 shadow-lg border border-black-100 bg-white">
                            <div className='w-[18rem] mx-auto space-y-4'>
                                <img alt='vision_image' src='https://phiedge.co.in/wp-content/uploads/mission-min.jpg' className='w-[18rem] h-[16rem] object-fill' />
